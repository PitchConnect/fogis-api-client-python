...
class SchemaValidator:
    ...
    @classmethod
    def validate_match_participants(cls, participants_data: Dict[str, Any]) -> bool:
        """
        Validate match participants data.

        Args:
            participants_data: The match participants data to validate
        ...
        Raises:
            jsonschema.exceptions.ValidationError: If the data is invalid
        """
        return cls.validate(participants_data, "match_participants_schema.json")
